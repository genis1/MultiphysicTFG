...
public class TriangularPrismTest extends ConstantUtils {
    ...
    private static void isPrismEqual() {
        ...
        TriangularPrism triangularPrism = Euclidean3DSpace.getOrCreateTriangularPrism(point0, point1, point2, direction, material, temperature);
